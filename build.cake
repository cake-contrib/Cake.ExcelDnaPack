...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./Cake.ExcelDnaPack.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./Cake.ExcelDnaPack.sln", new DotNetBuildSettings
    {
    ...
    .Does(() =>
{
    ...
    DotNetPack("./src/Cake.ExcelDnaPack/Cake.ExcelDnaPack.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
